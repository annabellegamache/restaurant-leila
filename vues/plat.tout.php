<div class="titre-page">
  ...
  <nav class="nav-principale">
    <a href="index.php?route=plat/tout" class="actif" title="Les menus">
    ...
    <a href="index.php?route=vin/tout" title="Carte des vins">
...
<div class="contenu-principal">
  ...
  <div class="carte">
    <!--Une section par catégorie de plat-->
    <?php foreach ($menu as $section => $plats) :  //$menu vient de l'étiquette...dans PlatControleur.cls.php ?>
    <section>
    <h2><?= $section; ?></h2>
    <ul><!--Un <li> par plat -->
