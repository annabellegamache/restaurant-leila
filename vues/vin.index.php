<div class="titre-page">
  ...
  <nav class="nav-principale">
    <a href="index.php?route=plat/tout" title="Les menus">
    ...
    <a href="index.php?route=vin/tout" class="actif" title="Carte des vins">
...
<div class="contenu-principal">
  ...
  <div class="carte">
  <!--Une section par catégorie de vin-->
  <?php foreach ($vin as $section => $vins) : ?>
    <section>
      <h2><?= strtoupper($section); ?></h2> <!-- Metter le titres des section en majuscule. -->
      <ul>
